...
public class HistoryFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        tt1.setTextColor(getResources().getColor(R.color.colorPrimary));
        ...
        tt2.setTextColor(getResources().getColor(R.color.colorPrimary));
        ...
        tt3.setTextColor(getResources().getColor(R.color.colorPrimary));
